...
class ChatApp extends React.Component {
    constructor(props) {
      super(props);
      this.state = { contacts: [{text:'Şerif Ali Palta', active:true},{text:'Resul Bozdemir', active:true},{text:'Melih Yumak', active:false}, {text:'Mert İsmail Köroğlu', active:false}],
